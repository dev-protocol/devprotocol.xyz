<template>
  <section
    class="overflow-hidden bg-white px-8 text-center dark:bg-darkPrimary"
  >
    <h2 class="m-8 mx-auto w-full text-5xl dark:text-white">Testimonials</h2>
    <div
    ...
    >
      ...
      <div class="relative lg:flex lg:items-center">
        <a :href="currentItem.link" class="hidden lg:block lg:flex-shrink-0">
          <img
            class="h-64 w-64 rounded-full bg-white xl:h-80 xl:w-80"
        ...
        <div class="relative lg:ml-10">
          ...
          <blockquote class="relative">
            <div
              class="text-2xl font-medium leading-9 text-gray-900 dark:text-gray-100"
            >
              <p>
              ...
              <a :href="currentItem.link">
                <div class="flex">
                  ...
                  <div class="ml-4 lg:ml-0">
                    <div
                      class="inline-flex items-center justify-around text-xl font-medium text-gray-900 underline dark:text-gray-100"
                    >
                      {{ currentItem.name }}
                    </div>
                  </div>
            ...
            <div class="flex items-center justify-between py-8">
              <p
                class="mt-6 cursor-pointer justify-self-end px-4 pl-0 font-mono font-bold underline lg:px-8 lg:pl-0"
                v-on:click="setCurrentItem(prevItem())"
              >
                &lt; Previous
              </p>
              <p
                class="mt-6 cursor-pointer justify-self-end px-4 pr-0 font-mono font-bold underline lg:px-8 lg:pr-0"
